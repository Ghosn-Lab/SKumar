...
pbmc.data = list(f1b1=mat1, f1b2=mat2, h1b1=mat3, h1b2=mat4)
...
k.suggest <- suggestK(lObj.pbmc, num.cores = 4, gen.new = T, plot.log2 = F,
                      nrep = 5)
lObj.pbmc <- optimizeALS(lObj.pbmc, k=25, thresh = 5e-5, nrep = 3)
